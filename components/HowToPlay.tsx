...
const HowToPlay = () => {
  return (
    ...
    <h2 className="text-3xl font-semibold text-purple-300 mb-8">How to play?</h2>
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-start gap-4">
        ...
        <div>
          ...
          <p className="text-sm text-purple-200">Got doubles? You’ll have another turn!</p>
        </div>
      </div>
    ...
    <hr className="my-10 border-purple-700" />

    <div className="flex mb-10">
      <div>
      <h3 className="text-xl font-semibold mb-2">Own a full property set?</h3>

      <p className="mb-2">Start building houses and hotels</p>
    ...
    <div className="text-lg mt-10 flex items-center gap-2 text-purple-400">
      <span className="text-2xl">⏩</span>
